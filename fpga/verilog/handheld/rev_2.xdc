...
set_property -dict { PACKAGE_PIN B11    IOSTANDARD LVCMOS33 } [get_ports { cart_bank0[1] }];
set_property -dict { PACKAGE_PIN B12    IOSTANDARD LVCMOS33 } [get_ports { cart_bank0[2] }];
set_property -dict { PACKAGE_PIN A13    IOSTANDARD LVCMOS33 } [get_ports { cart_bank0[3] }];
set_property -dict { PACKAGE_PIN B13    IOSTANDARD LVCMOS33 } [get_ports { cart_bank0[4] }];
set_property -dict { PACKAGE_PIN A14    IOSTANDARD LVCMOS33 } [get_ports { cart_bank0[5] }];
set_property -dict { PACKAGE_PIN B14    IOSTANDARD LVCMOS33 } [get_ports { cart_bank0[6] }];
set_property -dict { PACKAGE_PIN J13    IOSTANDARD LVCMOS33 } [get_ports { cart_bank0[7] }];
...
set_property -dict { PACKAGE_PIN F13    IOSTANDARD LVCMOS33 } [get_ports { cart_bank1[7] }];
...
set_property -dict { PACKAGE_PIN J14    IOSTANDARD LVCMOS33 } [get_ports { cart_pin30 }];
set_property -dict { PACKAGE_PIN H14    IOSTANDARD LVCMOS33 } [get_ports { cart_pin30_dir }];

# Pin 31: VIN (GB) / nIRQ (GBA)
set_property -dict { PACKAGE_PIN L13    IOSTANDARD LVCMOS33 } [get_ports { cart_pin31 }];
set_property -dict { PACKAGE_PIN L14    IOSTANDARD LVCMOS33 } [get_ports { cart_pin31_dir }];

# Cartridge bank directions
set_property -dict { PACKAGE_PIN F14    IOSTANDARD LVCMOS33 } [get_ports { cart_bank0_dir }];
...
set_property -dict { PACKAGE_PIN G13    IOSTANDARD LVCMOS33 } [get_ports { cart_en_3v3 }];
set_property -dict { PACKAGE_PIN G14    IOSTANDARD LVCMOS33 } [get_ports { cart_en_5v0 }];
...
# Link Port
########################################
set_property -dict { PACKAGE_PIN C1     IOSTANDARD LVCMOS33 } [get_ports { link_so     }];
set_property -dict { PACKAGE_PIN D2     IOSTANDARD LVCMOS33 } [get_ports { link_si     }];
set_property -dict { PACKAGE_PIN E2     IOSTANDARD LVCMOS33 } [get_ports { link_sd     }];
set_property -dict { PACKAGE_PIN G2     IOSTANDARD LVCMOS33 } [get_ports { link_sc     }];
set_property -dict { PACKAGE_PIN C2     IOSTANDARD LVCMOS33 } [get_ports { link_so_dir }];
set_property -dict { PACKAGE_PIN E1     IOSTANDARD LVCMOS33 } [get_ports { link_si_dir }];
set_property -dict { PACKAGE_PIN F1     IOSTANDARD LVCMOS33 } [get_ports { link_sd_dir }];
set_property -dict { PACKAGE_PIN G1     IOSTANDARD LVCMOS33 } [get_ports { link_sc_dir }];
...
# Vibration
########################################
set_property -dict { PACKAGE_PIN B1     IOSTANDARD LVCMOS33 } [get_ports { vibrate_en    }];
set_property -dict { PACKAGE_PIN A1     IOSTANDARD LVCMOS33 } [get_ports { vibrate_brake }];
